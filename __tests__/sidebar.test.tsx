...
test('Sidebar can be collapsed', () => {
  ...
  render(
    <ReqoreUIProvider>
      <ReqoreSidebar items={qorusSidebarItems} path='/' onCollapseChange={handleClick} />
    </ReqoreUIProvider>
  );
...
test('Bookmarks can be added and removed', () => {
  ...
  render(
    <ReqoreUIProvider>
      <ReqoreSidebar items={qorusSidebarItems} path='/' onBookmarksChange={handleBookmarksChange} />
    </ReqoreUIProvider>
  );
